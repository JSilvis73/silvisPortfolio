       ...
       <div className={`projectContainer`}>
            <div className={`projectWrapper displayFlexColCenter marginTop10perc  ${isShaking ? 'shake-animation' : ''}`}  onMouseEnter={startShaking}>
                ...
                <div className="card-inner displayFlexColCenter">
                 ...
                 <a href={props.url}><button className={`projectURL ${isHoveredOver? 'hoveredOver': ''}`} onMouseEnter={startHighlight} onMouseLeave={stopHighlight}> <GithubLogo />{props.urlDesc}</button></a>
                </div>
            </div>
        </div> 
